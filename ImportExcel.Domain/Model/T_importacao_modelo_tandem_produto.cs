...
{
    public class T_importacao_modelo_tandem_produto : ImportData, IImportSingleData
    {
        public T_importacao_modelo_tandem_produto()
        {
            id_t_importacao_modelo_tandem_produto = null;
        ...
        public int? id_t_importacao_modelo_tandem_produto { get; set; }
